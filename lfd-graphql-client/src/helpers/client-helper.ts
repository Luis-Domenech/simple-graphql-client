...
export const gen_client_types = async (data: GeneratorData, config: GeneratorConfig): Promise<string[]> => {
  ...
  client_types = [
    ...
    [
      ...
      `${i(1)}Output extends object ?`,
      `${i(1)}{ [Selection in keyof Common<SelectionSet, Output> as SelectionSet[Selection] extends false | string ? never : NestedType<Output[Selection]> extends Record<PropertyKey, unknown> ? IsEmptyObject<NestedType<Output[Selection]>> extends true ? never : Selection : Selection]: Output[Selection] } : `,
      `${i(1)}Output :`,
      ...
      `${i(4)}(`,
      `${i(5)}OutputFromUnion<SelectionSet[Selection], Output[Selection]> extends object ? `,
      `${i(5)}(`,
      `${i(6)}SelectionSet[Selection] extends true ? `,
      `${i(6)}BoundedOperationOutput_<RecursionOverride<OutputFromUnion<SelectionSet[Selection], Output[Selection]>, N>, [RecursionOverride<OutputFromUnion<SelectionSet[Selection], Output[Selection]>, N>, ...Depth], OutputFromUnion<SelectionSet[Selection], Output[Selection]>> :`,
      `${i(6)}SelectionSet[Selection] extends object ? `,
      `${i(6)}BoundedOperationResponse_<RecursionOverride<OutputFromUnion<SelectionSet[Selection], Output[Selection]>, N>, [RecursionOverride<OutputFromUnion<SelectionSet[Selection], Output[Selection]>, N>, ...Depth], SelectionSet[Selection], OutputFromUnion<SelectionSet[Selection], Output[Selection]>> :`,
      `${i(6)}null`,
      `${i(5)}) :`,
      `${i(5)}(`,
      `${i(6)}IsUnion<OutputFromUnion<SelectionSet[Selection], Output[Selection]>> extends true ? // Here means we have a union with an object and a primitive`,
      `${i(6)}( // Here we determine if what to do based on selection set and output`,
      `${i(7)}BoundedOperationResponse_<RecursionOverride<OutputFromUnion<SelectionSet[Selection], Output[Selection]>, N>, [RecursionOverride<OutputFromUnion<SelectionSet[Selection], Output[Selection]>, N>, ...Depth], SelectionSet[Selection], OutputFromUnion<SelectionSet[Selection], Output[Selection]>>`,
      `${i(6)}) :`,
      `${i(6)}OutputFromUnion<SelectionSet[Selection], Output[Selection]> // Here we know we just a primitive`,
      `${i(5)})`,
      ...
      `${i(1)}(`,
      `${i(2)}Output extends object ?`,
      `${i(2)}SelectionSet extends true ? // If true, we don't use Common<SelectionSet, Output> since that will result in {} since SelectionSet is not an object, we don't do this check in First REcursion since we already handle that case in main bounded response type`,
      `${i(2)}{ [Selection in keyof Output as NestedType<Output[Selection]> extends Record<PropertyKey, unknown> ? IsEmptyObject<NestedType<Output[Selection]>> extends true ? never : Selection : Selection]: `,
      `${i(3)}(`,
      `${i(4)}IsUnion<NestedType<Output[Selection]>> extends true ? `,
      `${i(4)}(`,
      `${i(5)}OutputFromUnion<BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, Output[Selection]> extends object ? `,
      `${i(5)}(`,
      `${i(6)}BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]> extends true ? `,
      `${i(6)}BoundedOperationOutput_<N, [N, ...Depth], OutputFromUnion<BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, Output[Selection]>> :`,
      `${i(6)}BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]> extends object ? `,
      `${i(6)}BoundedOperationResponse_<N, [N, ...Depth], BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, OutputFromUnion<BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, Output[Selection]>> :`,
      `${i(6)}null`,
      `${i(5)}) :`,
      `${i(5)}(`,
      `${i(6)}IsUnion<OutputFromUnion<BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, Output[Selection]>> extends true ? // Here means we have a union with an object and a primitive`,
      `${i(6)}( // Here we determine if what to do based on selection set and output`,
      `${i(7)}BoundedOperationResponse_<N, [N, ...Depth], BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, OutputFromUnion<BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, Output[Selection]>>`,
      `${i(6)}) :`,
      `${i(6)}OutputFromUnion<BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, Output[Selection]> // Here we know we just a primitive`,
      `${i(5)})`,
      `${i(4)}) :`,
      `${i(4)}NestedType<Output[Selection]> extends object ? `,
      `${i(4)}(`,
      `${i(5)}BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]> extends true ? `,
      `${i(5)}BoundedOperationOutput_<N, [N, ...Depth], NestedType<Output[Selection]>> :`,
      `${i(5)}BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]> extends object ? `,
      `${i(5)}BoundedOperationResponse_<N, [N, ...Depth], BoundedOperationSelectionSetType_<N, [N, ...Depth], Output[Selection]>, NestedType<Output[Selection]>> :`,
      `${i(5)}null`,
      `${i(4)}) :`,
      `${i(4)}NestedType<Output[Selection]>`,
      `${i(3)})`,
      `${i(2)}} :`,
      `${i(2)}SelectionSet extends object ?`,
      `${i(2)}{ [Selection in keyof Common<SelectionSet, Output> as SelectionSet[Selection] extends false | string ? never : NestedType<Output[Selection]> extends Record<PropertyKey, unknown> ? IsEmptyObject<NestedType<Output[Selection]>> extends true ? never : Selection : Selection]: `,
      `${i(3)}(`,
      `${i(4)}IsUnion<NestedType<Output[Selection]>> extends true ? `,
      `${i(4)}(`,
      ...
      `${i(5)}(`,
      `${i(6)}SelectionSet[Selection] extends true ? `,
      `${i(6)}BoundedOperationOutput_<N, [N, ...Depth], OutputFromUnion<SelectionSet[Selection], Output[Selection]>> :`,
      `${i(6)}SelectionSet[Selection] extends object ? `,
      `${i(6)}BoundedOperationResponse_<N, [N, ...Depth], SelectionSet[Selection], OutputFromUnion<SelectionSet[Selection], Output[Selection]>> :`,
      `${i(6)}null`,
      `${i(5)}) :`,
      `${i(5)}(`,
      `${i(6)}IsUnion<OutputFromUnion<SelectionSet[Selection], Output[Selection]>> extends true ? // Here means we have a union with an object and a primitive`,
      ...
      `${i(3)})`,
      `${i(2)}} :`,
      `${i(2)}null : // If SelectionSet is not true or object`,
      `${i(2)}SelectionSet extends true ? `,
