...
export const PACKAGE_NAME = 'simple-graphql-client'
export const PACKAGE_FULL_NAME = 'Simple GraphQL Client'
...
export const RECURSION_WARNING_THREHSOLD = 3
...
export const DEFAULT_CONFIG: GeneratorConfig = {
  ...
  client: {
    output_dir: './src/generated/simple-graphql-client/client',
    to_run: false,
    fetch_delay: 3000,
...
export const DEFAULT_ENV_SUBS = [
  {name: 'NODE_ENV', value: process.env.NODE_ENV === "production" ? "true" : "false"},
]
